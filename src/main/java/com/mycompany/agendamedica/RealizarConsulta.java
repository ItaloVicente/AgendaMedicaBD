...
public class RealizarConsulta extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i =0;i<consultas.size();i++){
            ...
            if(consulta.getData().equals(dataFormatada)){
                DefaultTableModel dtmConsultas = (DefaultTableModel) jtConsultas.getModel();
                Date dataMarcada = formatoDesejado.parse(consulta.getData());
                String dataConsulta = formatoOriginal.format(dataMarcada);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            ArrayList<Consulta> listaEspera = medico.getListaEspera();
            for(Consulta consultaEspera : listaEspera){
                if(consultaEspera.getData().equals(data)&&consultaEspera.getHorario().equals(horario)){
                    daoc.delete(consultaEspera);
                }
            }
            DefaultTableModel table = (DefaultTableModel) jtConsultas.getModel();
            int index5 = table.getRowCount();
