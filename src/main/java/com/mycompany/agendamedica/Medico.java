...
public class Medico {
    ...
    public ArrayList<Consulta> getListaEspera() {
        ConsultaDAO daoc = new ConsultaDAO();
        ArrayList<Consulta> listaDeEspera = daoc.getConsultaListaEsperaMedico(this.id);
        for(Consulta consulta : listaDeEspera){
    ...
    public double calcularMedia(){
        ConsultaDAO daoc = new ConsultaDAO();
        ArrayList<Consulta> consultasAvaliadas = daoc.getConsultasAvaliadas(this.id);
        for(Consulta consulta : consultasAvaliadas){
            this.adicionarNota(consulta.getNota());
        }
        double media = 0;
        double som = 0;
